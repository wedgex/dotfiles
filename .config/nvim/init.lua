...
vim.opt.listchars = { space = '_', trail = '.' }
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'ruby', 'lua', 'javascript', 'yaml', 'tsx', 'typescript', 'vim', 'svelte' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('H', vim.lsp.buf.hover, '[H]over Documentation')
  nmap('<C-d>', vim.lsp.buf.signature_help, 'Signature [D]ocumentation Help')
...
if string.match(vim.fn.getcwd(), "workspaces/calendly") then
